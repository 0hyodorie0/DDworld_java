...
<body>
<form id="diaryForm" action="<%=request.getContextPath()%>/diaryUpdate.do" method="post" >

<!-- <table width="100%"> -->
<!--         <tr> -->
<!--           <td> -->
<textarea rows="10" cols="30" id="diaContent" name="diaContent" style="width:650px; height:350px; "><%=request.getParameter("cont") %></textarea>
<!--            </td> -->
<!--         </tr> -->
...
<!--         <td> -->
   		 ...
   		 <input type="hidden" name="diaType" id="diaType" value="<%=request.getParameter("type") %>"> 
   		 <input type="hidden" name="diaNo" id="diaNo" value="<%=request.getParameter("no") %>"> 
<!--    		 </td> -->
<!--         </tr> -->
